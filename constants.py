...
database_path = os.path.join(os.path.abspath(os.path.dirname(__file__)), 'gameinfo')
image_cache = os.path.join(os.path.abspath(os.path.dirname(__file__)), 'gameinfo', 'imagecache')
